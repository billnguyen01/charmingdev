...
class custom_sale_order(models.Model):
    ...
    abk_amount = fields.Integer('Amount')
    abk_hk_amount = fields.Integer('HKAmount')
    ...
    abk_amendment_tiem = fields.Char('Amendment Tiem')
    ...
    abk_po_number = fields.Integer('PO number')
    ...
    abk_customer_number = fields.Integer('Customer number')
