...
class PurchaseOrderCustom(models.Model):
    ...
    abk_stockqty = fields.Char('Stock quantity')
    abk_actqty = fields.Char('Actual quantity')
    abk_poqty = fields.Char('PO Quantity')
    ...
    abk_receivequantity = fields.Integer('Receive quantity')
