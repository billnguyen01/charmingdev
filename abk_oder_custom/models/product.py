...
class ProductTemplateCustom(models.Model):
    ...
    abk_minimum_qty = fields.Char('Min On-Hand')
    abk_maximum_qty = fields.Char('Max On-Hand')
    abk_safety_qty = fields.Char('Safety Stock')
    abk_reorder_level = fields.Char('Re-Order to Max')
    abk_minorder_qty = fields.Char('Min Order Qty')
    ...
    abk_part_description = fields.Char('Description')
